...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img src="http://
ozp828v10.bkt.clouddn.com/${product.productImage}?imageView2/1/w/300/h/300" alt="">
            </div>
            <div class="col-md-8">
    ...
    <script>
        $(function () {
            $("#clock").countdown(${product.isStartTs},function(event) {
            ...
            $("#secKillBtn").click(function () {
               $.get("/product/killProduct/${product.id}").done(function (json) {
